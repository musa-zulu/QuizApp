    ...
    public static class ConfigureServiceContainer
    {
             ...
             IConfiguration configuration, IConfigurationRoot configRoot)
        {
            serviceCollection.AddDbContext<ApplicationDbContext>(options =>
                   options.UseSqlServer(configuration.GetConnectionString("QuizAppConn") ?? configRoot["ConnectionStrings:QuizAppConn"]
        ...
        public static void AddSwaggerOpenAPI(this IServiceCollection serviceCollection)
        {
            serviceCollection.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    ...
                    new OpenApiInfo()
                    {
                        Title = "QuizApp Architecture WebAPI",
                        Version = "1",
                        Description = "Through this API you can access quiz information",
